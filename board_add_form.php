...
<!-- board_add_form.php -->
    <div class="container">
        <div class="max-w-xl mx-auto">
            <form action="/board_add_action.php" method="post" enctype="multipart/form-data" class="bg-white rounded px-4 pt-6 pb-8 mb-4">
                <!-- Password Input -->
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="image" id="image" accept="image/*">
                </div>
